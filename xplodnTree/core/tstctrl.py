...
if __name__ == "__main__":
	...
	df.to_csv('ProdRules/david.tsv', header=False, index=False, sep="\t")

	xrules = [
					("r0.0",	"S",	['0,1,2,3,5,6,7:N', '4:T'],	1.0),
					("r1.0",	"A,B,C,D,E,F,G",	['A,B,0,D,E,F,G,H:N', 'C:T'],	0.0714285714286),
					("r1.1",	"A,B,C,D,E,F,G,H",	['B,0,C,D,E,F,G,H:N'],	0.0714285714286),
					("r1.2",	"A,B,C,D,E,F,G,H",	['A,C,D,E,F,G,H:N', 'B:T'],	0.0714285714286),
					("r1.3",	"A,B,C,D,E,F,G,H",	['A,B,C,E,0,F,G,H:N', 'D:T'],	0.0714285714286),
					("r1.4",	"A,B,C,D,E,F,G,H",	['0:T', 'C:T', 'B:T', 'E:T', 'D:T', 'G:T', 'F:T', 'H:T'],	0.0714285714286),
					("r1.5",	"A,B,C,D,E,F,G,H",	['A,B,C,D,E,G,0,H:N', 'F:T'],	0.0714285714286),
					("r1.6",	"A,B,C,D,E,F,G,H",	['A,B,D,E,F,G,H,0:N', 'C:T'],	0.0714285714286),
					("r1.7",	"A,B,C,D,E,F,G,H",	['A,B,C,D,E,F,G,H:N'],	0.5)
					]
	df = pd.read_csv('ProdRules/david.tsv', header=None, sep="\t")
